...
def main():
    ...
    print("Accuracy of classifiction algorithm with Decision Tree classifier is ",Accuracy*100,"%")

    Accuracy = MarvellousCalculateAccuracyKNeighbor()
    print("Accuracy of classifiction algorithm with K Neighbors classifier is ",Accuracy*100,"%")
